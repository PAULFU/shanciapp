...
import com.fupinyou.shanci.shanciapp.Word;

// THIS CODE IS GENERATED BY greenDAO, DO NOT EDIT.
/** 
 * DAO for table ENGLISHWORDTABLE.
*/
public class WordDao extends AbstractDao<Word, Long> {

    public static final String TABLENAME = "ENGLISHWORDTABLE";
    ...
    */
    public static class Properties {
        ...
        public final static Property Wordcontent = new Property(1, String.class, "wordcontent", false, "WORDCONTENT");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'ENGLISHWORDTABLE' (" + //
                "'_id' INTEGER PRIMARY KEY AUTOINCREMENT ," + // 0: id
                "'WORDCONTENT' TEXT," + // 1: wordcontent
                "'SENTENCE' TEXT);"); // 2: sentence
    }

    /** Drops the underlying database table. */
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'ENGLISHWORDTABLE'";
        db.execSQL(sql);
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Word entity) {
        ...
        String wordcontent = entity.getWordcontent();
        if (wordcontent != null) {
            stmt.bindString(2, wordcontent);
        }
    ...
    public Word readEntity(Cursor cursor, int offset) {
        Word entity = new Word( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // wordcontent
    ...
    public void readEntity(Cursor cursor, Word entity, int offset) {
        ...
        entity.setWordcontent(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
